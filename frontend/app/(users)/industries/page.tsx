...
export default function IndustriesPage() {
  ...
  return (
    <main>
      {/* Hero */}
      <section
        className="relative isolate overflow-hidden rounded-b-3xl pt-32 lg:pt-40"
      ...
      >
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 lg:pb-24">
